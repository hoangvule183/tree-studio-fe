    ...
    <div className="w-screen h-screen bg-[url(/images/portfolio/bg.png)] bg-fixed bg-cover bg-center overflow-y-auto flex flex-wrap justify-center pt-20 pb-[200px]">
            ...
            (r) =>
              !r.is_thumbnail && (
                <img
                  ...
                  className="rounded-md shadow-md hover:brightness-50 hover:shadow-xl hover:-translate-x-1 hover:-translate-y-1 transition-all"
                />
              )
          )}
      </StackGrid>
      {previewPhoto && (
        <div
          ...
          className="w-screen h-screen fixed top-0 left-0 bg-[rgba(0,0,0,0.7)] z-[500] flex items-center justify-center"
        >
          <img
            referrerPolicy="no-referrer"
            src={`https://lh3.googleusercontent.com/d/${previewPhoto}`}
            className="rounded-xl shadow-xl select-none w-[92%]"
          />
        </div>
      )}
    </div>
