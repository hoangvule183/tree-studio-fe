    ...
    <div className="w-screen h-screen max-md:hidden overflow-y-scroll">
      ...
      <div className="absolute top-[25%] left-[68%] text-balance select-none text-[rgba(42,28,87,1)] flex flex-col gap-[10px]">
        ...
        <div className="flex gap-[5px] items-center">
          ...
          <a href="mailto:info@tree.net.vn" className="hover:underline">info@tree.net.vn</a>
        </div>
        <div className="flex gap-[5px] items-center">
          <img src="/images/icons/phone.png" className="w-[30px]" />
          <div className="flex flex-col">
            <a href="tel:+84907677222" className="hover:underline">(+84)907 677 222 (Kei)</a>
            <a href="tel:+84938841562" className="hover:underline">(+84)938 841 562 (Thao)</a>
          </div>
        </div>
        <div className="flex gap-[5px] items-center">
